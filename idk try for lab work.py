...
def game_start():
    ...
    def power_computation(player_pokemon, opponent_pokemon, player_power_base=0,
                          opponent_power_base=0):  # Done: Able to save player and opponent power base
    ...
    def element_interaction_buffsandnerfs(player_pokemon, opponent_pokemon, player_power_base,
                                          opponent_power_base):  # Done: Able to save final power of both player and opponent
    ...
    def battle(player_pokemon, opponent_pokemon, final_player_power, final_opponent_power, voicelines=voicelines,
               ending_voicelines=ending_voicelines, match_id=0):
        ...
        if user_input.lower() == "a":
            while True:
                ...
                final_player_power, final_opponent_power, player_buffornerf, opponent_buffornerf = element_interaction_buffsandnerfs(
                    ...
                    player_power_base=player_power_base, opponent_power_base=opponent_power_base)
                battle_outcome, post_player_power_base, post_opponent_power_base, match_id = battle(
                    player_pokemon=player_pokemon, opponent_pokemon=opponent_pokemon,
                    final_player_power=final_player_power, final_opponent_power=final_opponent_power)
                ...
                while True:
                    ...
                    print(
                        f"Enter the following keys of your selection:\n'c' : Change Character\n'x' : Exit Program\n'm' : Monitor History\n",
                        end="")
